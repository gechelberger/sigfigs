...
KEYWORDS = ["c-extension", "Significant Digits"]
CLASSIFIERS = [
...
setup(
    ...
    url="https://github.com/gechelberger/sigfigs",
    version="1.0.0a1",
    description="cython significant figures tracking utility",
